...
void InsertCustomer::on_pushButton_clicked()
{
    QSqlQuery  q;
...
if(!q.exec()){
    QMessageBox::information(this,"","Customer was not added successfully!");
}
else{

    QMessageBox::information(this,"","Customer was added successfully!");
